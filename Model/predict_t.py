...
model_path = "/mnt/data/trained_transformer_model"  # Update with actual model path
...
### **🔹 Predict Player Statlines Given Opponent Defensive Rating**
def predict_statline(new_game):
    ...
    new_game_tensor = np.array(new_game_scaled).reshape(1, 10, len(feature_columns))  # Match Transformer input shape
